    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(item.getItemId()){
                    case R.id.info_user:
                        ...
                        return true;
                    case R.id.home_user:
                        startActivity(new Intent(UserSettings.this, UserHome.class));
                        overridePendingTransition(0, 0);
                        return true;
                    case R.id.ajustes:
        ...
        settings_option1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(UserSettings.this, UsarChaleco.class);
                startActivity(i);
            }
        });
        ...
        settings_option2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(UserSettings.this, UsarApp.class);
                startActivity(i);
            }
        });
        ...
        settings_option3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(UserSettings.this, RitmoCardiaco.class);
                startActivity(i);
            }
        });
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (selectedLang.equals("Español")){
                    setLocal(UserSettings.this, "es");

                    Intent intent = new Intent(UserSettings.this, UserHome.class);
                    startActivity(intent);
                }
                else if(selectedLang.equals("English")){
                    setLocal(UserSettings.this, "en");
                    Intent intent = new Intent(UserSettings.this, UserHome.class);
                    startActivity(intent);
                }
